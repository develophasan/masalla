    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-sky-50 via-purple-50 to-white">
        ...
        <div className="max-w-md mx-auto px-4 py-20 text-center">
          ...
          {/* Content Safety Notice - Also shown for non-authenticated users */}
          <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl flex items-start gap-3 text-left">
            ...
            <div>
              <p className="text-green-800 font-medium text-sm">Çocuk Güvenliği Koruması</p>
              <p className="text-green-600 text-xs">
                Tüm içerikler otomatik olarak filtrelenir. Uygunsuz içerik engelenir.
              </p>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 via-purple-50 to-white pb-20 sm:pb-0">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl flex items-start gap-3">
          ...
          <div>
            <p className="text-green-800 font-medium">Çocuk Güvenliği Koruması Aktif</p>
            <p className="text-green-600 text-sm">
              Tüm içerikler otomatik olarak filtrelenir. Küfür, uygunsuz kelime ve zararlı içerik içeren masallar oluşturulamaz.{" "}
              <Link to="/terms" className="underline hover:text-green-700">Detaylı bilgi</Link>
            </p>
          </div>
        </div>
