...
import { BookOpen, Mail, Lock, Eye, EyeOff, Loader2, Home, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 via-purple-50 to-white flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-100">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full bg-violet-500 hover:bg-violet-600 text-white py-6 rounded-xl font-medium"
            >
              {loading ? (
        ...
        <p className="mt-4 text-center text-slate-400 text-xs">
          <Link to="/admin/login" className="hover:text-slate-600">
            Admin Girişi
          </Link>
        </p>
      </div>
