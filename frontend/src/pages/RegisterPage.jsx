...
import { BookOpen, Mail, Lock, Eye, EyeOff, Loader2, User, Phone, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 via-purple-50 to-white flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="mt-6 text-2xl font-bold text-slate-800">Kayıt Ol</h1>
          <p className="mt-2 text-slate-500">Yeni hesap oluşturun</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-100">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full bg-violet-500 hover:bg-violet-600 text-white py-6 rounded-xl font-medium mt-2"
            >
              {loading ? (
                <><Loader2 className="w-5 h-5 mr-2 animate-spin" /> Kayıt yapılıyor...</>
              ) : (
                'Kayıt Ol'
              )}
            </Button>
          ...
          <Button
            ...
            className="w-full py-6 rounded-xl font-medium border-slate-200 hover:bg-slate-50"
          >
